	...
	public static void main(String[] args) {
        ...
        for(int i=0;i<n;i++)
        {
            ...
            //B 
             for(int j=0;j<n;j++)
             {
                 if(j==0||(i==0 && j<n/2)||(i==n/2 && j<n/2)||(i==n-1 && j<n/2)||(j==n/2 && i!=n/2 && i!=n-1 && i>0)){
                     System.out.print("*");
                 }
                 else{
                     System.out.print(" ");
             ...
             //D
              ...
              //E
               for(int j=0;j<n;j++)
               {
                   if((i==0&&j<=n/2)||(i==n-1&&j<=n/2)||(i==n/2&&j<=n/2)||(j==0)){
                       System.out.print("*");
                   }
                   else{
                       System.out.print(" ");
             ...
             //J
               for(int j=0;j<n;j++)
               {
                   if((i==0&&j<n/2)||(j==n/4)||(i==n-1&&j<=n/4)||(i>=3*n/4&&j==0)){
                       System.out.print("*");
                   }
                   else{
                       System.out.print(" ");
             ...
             //P
               for(int j=0;j<n;j++)
               {
                   if((j==0&&i>0)||(i==0&&j!=0&&j<n/2)||(j==n/2&&i>0&&i<n/2)||(i==n/2&&j<n/2)){
                       System.out.print("*");
                   }
                   else{
                       System.out.print(" ");
             ...
             //Q
               ...
               for(int j=0;j<n;j++)
               {
                   if((i==0&&j!=0&&j<(3*n)/4)||(j==0&&i>0&&i<(3*n)/4)&&i>0||(i==(3*n)/4&&j!=0&&j<(3*n)/4)||(j==(3*n)/4&&i>0&&i<(3*n)/4)||(i==j&&i>=n/2)){
                       System.out.print("*");
                   }
                   else{
                       System.out.print(" ");
             ...
             //S
               for(int j=0;j<n;j++)
               {
                   if((i==0&&j!=0&&j<=n/2)||(j==0&&i<n/2&&i!=0)||(i==n/2&&j!=0&&j<n/2)||(j==n/2&&i>n/2&&i!=n-1)||(i==n-1&&j<n/2)){
                       System.out.print("*");
                   }
                   else{
                       System.out.print(" ");
